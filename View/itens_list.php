...
$sql = "SELECT * FROM tb_itens  LIMIT $ini, $quant_page_res";
...
<body>
    ...
    <section class="product-shop spad">
        ...
        <div class="col-lg-12 text-center">
                    <?php
                    $sql = "SELECT COUNT(idItem) AS num_result FROM tb_itens";
                    ...
                    for($page_previous = $page - $max_links; $page_previous <= $page - 1; $page_previous++){
                        if($page_previous >= 1){
                            echo "<li class='page-item'><a class='page-link' href='itens_list.php?page=$page_previous'>$page_previous</a></li>";
                        }
                    }
                    ...
                    for($page_next = $page + 1; $page_next <= $page + $max_links; $page_next++){
                        ...
                        echo "<li class='page-item'><a class='page-link' href='itens_list.php?page=$page_next'>$page_next</a></li>";
                        }
                    }
                echo "<li class='page-item'><a class='page-link btn primary-btn' href='itens_list.php?page=$quant_page' aria-label='Próximo'>
