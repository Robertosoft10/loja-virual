        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <?php if($_SESSION['user_existe']) { ?>
                    <div class="alert alert-danger">
                    <?= $_SESSION['user_existe'];?>
                    </div>
                    <?php unset($_SESSION['user_existe']); } ?>
                    <div class="register-form">
                        <h2>Cadastrar - se</h2>
                        <form action="../Controller/insert_user_cart_site.php" method="post">
                            <div class="group-input">
                                <input type="text" name="username" id="username" placeholder="Nome de Usuário *" required="">
                            </div>
                            <div class="group-input">
                                <input type="email" name="user_email" id="pass" placeholder="E-mail de Usuário *" required="">
                            </div>
                            <div class="group-input">
                                <input type="password" name="password" id="con-pass" placeholder="Senha de Usuário *" required="">
                            </div>
                            <button type="submit" class="site-btn register-btn">Salvar Cadastro</button>
                        </form>
                    </div>
                </div>
            </div>
